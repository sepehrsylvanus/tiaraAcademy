        ...
        >
          ...
          {locale === "fa" ? (
            <div className="space-y-6">
              <div className="bg-extraText space-y-6 p-2 rounded-md text-white">
              ...
              <div>
                ...
                <p>
                  ماموریت ما در آکادمی تیارا این است که مهارت‌های زبانی لازم را
                  به افراد آموزش دهیم تا بتوانند با جهان اطراف خود ارتباط برقرار
                  کنند. ما باور داریم که زبان فراتر از یک ابزار ارتباطی است؛
                  زبان کلیدی است برای درک فرهنگ‌ها، دیدگاه‌ها و ایده‌های متفاوت.
                </p>
              </div>
              <div className="bg-extraText space-y-6 p-2 rounded-md text-white">
                ...
                <p>
                  ...
                  حرفه‌ای را نمی‌گیرند. هدف ما تبدیل‌شدن به پیشروترین پلتفرم
                  آموزش زبان در ایران است، با ارائه راهکارهای نوآورانه و در
                  دسترس برای تمام سطوح یادگیری.
                </p>
              </div>
              <div>
                <h2 className="text-3xl font-bold">خدمات ما</h2>
                <p>
                  ما طیف گسترده‌ای از خدمات را ارائه می‌دهیم که متناسب با
                  نیازهای متنوع زبان‌آموزان طراحی شده‌اند:
                </p>
                <ul>
                  <li>
                    <span className="font-bold">کلاس‌های تعاملی آنلاین</span>
                    یادگیری زنده با اساتید حرفه‌ای برای تقویت مهارت‌های زبانی
                    شما.
                  </li>
                  <li>
                    <span className="font-bold">دوره‌های ویدیویی جامع: </span>
                    آموزش با ساختار دقیق و محتوای باکیفیت، مناسب برای یادگیری با
                    سرعت دلخواه.
                  </li>
                  <li>
                    <span className="font-bold">مقالات آموزشی وبلاگ: </span>
                    نکات، راهکارها و استراتژی‌های مفید برای بهبود مسیر یادگیری
                    زبان
                  </li>
                  <li>
                    <span className="font-bold">تدریس خصوصی: </span>مشاوره فردی
                    و اختصاصی برای دستیابی به اهداف زبان‌آموزی شما.
                  </li>
                </ul>
              </div>
              <div className="bg-extraText space-y-6 p-2 rounded-md text-white">
                ...
                <ul>
                  ...
                  <li>
                    <span className="font-bold">نوآوری در یادگیری: </span>
                    ابزارهای تعاملی ما از جدیدترین تکنولوژی‌های آموزشی بهره
                    می‌برند تا تجربه‌ای مدرن و جذاب فراهم کنند.
                  </li>
                  <li>
                    <span className="font-bold">انعطاف‌پذیری: </span>با
                    گزینه‌هایی که مطابق برنامه روزانه شما طراحی شده‌اند، یادگیری
                    آسان‌تر و در دسترس‌تر خواهد بود.
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-extraText space-y-6 p-2 rounded-md text-white">
                ...
                <p>
                  آماده‌اید تا مسیر یادگیری زبان خود را آغاز کنید؟ دوره‌های ما
                  را کشف کنید، به جامعه بزرگ ما بپیوندید و اولین قدم را برای
                  تغییر آینده خود بردارید!
                </p>
              </div>
            </div>
          ) : (
